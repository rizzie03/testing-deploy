...
import detailstyle from "./detailsuser.module.scss";
        ...
        <div className={detailstyle.Content}>
          ...
          <div className={detailstyle.Container}>
            ...
            <p>
              ...
              prepare anything--just prepare to have fun and try!
            </p>
            <br />
            ...
            <br />
            <p>
              1) This event is not a lecture or conversation practice. This is a
              structured activity in which all attendees are expected to
              actively participate.
            </p>
            <br />
            <p>
              2) Participation in "English on Your Feet!™ is optimal for English
              language learners at the intermediate level and above.
            </p>
            <br />
            <p>
              ...
              maximum of 2 times then must join to continue.
            </p>
            <br />
            <p>
          ...
          <div className={detailstyle.commentSection}>
            ...
            <p>4 hours ago</p>
            <p>
              Hi pratur! I like your event, I already sent you an email about my
              upcoming event, could you hosted my event?
            </p>
            <img
              className={detailstyle.Avatar}
          ...
          <div className={detailstyle.commentUser}>
            <img
              className={detailstyle.Avatar}
              src='https://s3-alpha-sig.figma.com/img/84fd/f4b2/bcfdf270fa5a1ac8f5f7bbf9b30301f6?Expires=1637539200&Signature=YpZU7zYxskf-vFSWPPdqHW~bjC47ffO9qAdvRQgf7nI48l0ERzSs1d~Qpn3f5MFWyLd31bk9DZMMxub8CsNwEY9z3b5jEbzhDqRX0ZVrW90G0mT0A7c1HlK0ieHDormU7tB9tboQLUVnu0--jjUZWlDoxkoOHz3a3Is9E1rE6FBA79Eq8uS4re1AoWiuk10acwNwz0yiblASZGOJO5F~FBsWya1FNi5k5Of3J-4JbCbR4~0aFrthayJRoS2K~To7y96ex5-kFoyk4fjJqViFkFx8rVf9aBJjmLIjTA3zYu8vJ1hEsD4ak1jrosTAmGcWNKaS4VO2sSxhxX0S1J-maQ__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA'
              alt=''
            />
            <div>
              <input
                ...
                name='title'
              />
              <button className={detailstyle.Button}>
                <FiMessageCircle className={detailstyle.Icon} />
                Submit
              </button>
            </div>
          </div>
